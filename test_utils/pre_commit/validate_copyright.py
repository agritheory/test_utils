...
def validate_copyright(app_config, files):
    ...
    if isinstance(app_config, str):
        ...
        app_publisher = app_config.get("app_publisher", "")
    else:
        raise ValueError(
            "app_config must be either a string (app path) or dictionary with 'app_publisher' key"
        )
